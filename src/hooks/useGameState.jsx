...
export function useGameState() {
    ...
    const [isAvatarSelectionModalOpen, setIsAvatarSelectionModalOpen] = useState(false); // <-- НОВОЕ СОСТОЯНИЕ
    ...
    const handlers = usePlayerActions(
        ...
        setIsAvatarSelectionModalOpen // <-- ПЕРЕДАЕМ НОВОЕ СОСТОЯНИЕ
    );
    ...
    return {
        ...
        isAvatarSelectionModalOpen, // <-- ВОЗВРАЩАЕМ НОВОЕ СОСТОЯНИЕ
        handlers,
        removeToast,
